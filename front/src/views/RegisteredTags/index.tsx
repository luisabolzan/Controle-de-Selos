...
import AdminTagCard from "../../components/AdminTagCard";
          ...
          <GridCardsContainer>
            ...
            <RequestCardsContainer isBarExpanded = {isBarExpanded}>
              ...
              {showToast && toastType && (
                <Toast
                  type="success"
                  message= "Selo Recebido com Sucesso"
                  description="Este selo está disponivel para outros usuários"
                  onClose={() => {
                    setToastVisible(false);
