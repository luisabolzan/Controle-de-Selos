...
import { AdminTagCardProps } from "./types";
...
const AdminTagCard: React.FC<AdminTagCardProps> = ({
  tag,
...
function dateToDdMmYyyy(dataIso: string): string {
  ...
  const TagIcons = [User, Phone, Email];
        ...
        <TagTextGroup>
          ...
          <StatusIconWrapper>
            ...
            <TagName>
              ...
              {tag?.is_approved ? (
                <UserRoundCheck color="green" size={24} />
              ) : (
                <UserRoundX color="red" size={24} />
              )}
